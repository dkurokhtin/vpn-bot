...
## 🧠 Основная логика
 ...
 - 📦 `/start` — предлагает ознакомиться с политикой конфиденциальности и после согласия выдаёт бесплатную 7‑дневную подписку, создаёт клиента в XUI, сохраняет `xrayUuid` и ссылку. Если пользователь уже зарегистрирован, эта команда просто покажет его текущий статус и ссылку на конфигурацию
